...
<html>
<head>
<title>VMl generato da SVG</title>
...
<xsl:text>left: </xsl:text>
    <xsl:choose><xsl:when test="@x"><xsl:value-of select="@x" /></xsl:when>
    <xsl:otherwise><xsl:text>0</xsl:text></xsl:otherwise></xsl:choose>
<xsl:text>; </xsl:text>
<xsl:text>top: </xsl:text>
    <xsl:choose><xsl:when test="@y"><xsl:value-of select="@y" /></xsl:when>
    <xsl:otherwise><xsl:text>0</xsl:text></xsl:otherwise></xsl:choose>
<xsl:text>; </xsl:text>
...
<xsl:text>; </xsl:text>
<xsl:text>z-index: -</xsl:text><xsl:value-of select="$n-elementi" /><xsl:text>;</xsl:text>
</xsl:attribute>
...
<xsl:choose>
    ...
    -->
    <xsl:otherwise>
        <xsl:attribute name="coordorigin"><xsl:text>0 0</xsl:text>
        </xsl:attribute>
...
<xsl:include href="XSL2/rect.xsl" />
<xsl:include href="XSL2/dimensioni.xsl" />
<xsl:include href="XSL2/transform.xsl" />  
<xsl:include href="XSL2/xywh.xsl" />
<xsl:include href="XSL2/predef.xsl" />
<xsl:include href="XSL2/attributi-paint.xsl" />
<xsl:include href="XSL2/text.xsl" />
<xsl:include href="XSL2/text-dim.xsl" />
<xsl:include href="XSL2/text-elemento.xsl" />
<xsl:include href="XSL2/text-ric.xsl" />
<xsl:include href="XSL2/gradient-pattern.xsl" />
<xsl:include href="XSL2/marker.xsl" />
<xsl:include href="XSL2/filter.xsl" />
<xsl:include href="XSL2/gestione-style.xsl" />
<xsl:include href="XSL2/path.xsl" />
<xsl:include href="XSL2/matematica.xsl" />
